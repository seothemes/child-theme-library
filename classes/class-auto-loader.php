...
class Auto_Loader {
	...
	public function __construct() {
		...
		$this->register_class_autoloader();
	 ...
	 * the autoloader will look in the root /classes/ folder for a file
	 * that corresponds with the class name being called. This allows
	 * you to call classes without having to import them.
	 *
	 * @since  1.0.0
	 *
	 ...
	 * @return void
	 */
	public function register_class_autoloader() {
