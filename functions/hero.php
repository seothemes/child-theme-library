 ...
 *
 * @package   SEOThemes\ChildThemeLibrary\HeroSection
 * @since     1.0.0
...
namespace SEOThemes\ChildThemeLibrary\HeroSection;

add_action( 'genesis_before', __NAMESPACE__ . '\setup' );
/**
 * Set up hero section.
 *
...
function setup() {
	...
	add_action( 'child_theme_hero_section', __NAMESPACE__ . '\title', 10 );
	add_action( 'child_theme_hero_section', __NAMESPACE__ . '\excerpt', 20 );
	...
	add_action( 'genesis_before_content_sidebar_wrap', __NAMESPACE__ . '\display' );
...
function title_toggle() {
	...
	remove_action( 'child_theme_hero_section', __NAMESPACE__ . '\title', 10 );
	remove_action( 'child_theme_hero_section', __NAMESPACE__ . '\excerpt', 20 );
